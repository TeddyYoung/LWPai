...
/**
 * Default implementation of {@linkplain com.zftlive.android.library.third.universalimageloader.cache.disc.DiskCache disk cache}.
...
public class UnlimitedDiskCache extends BaseDiskCache {
	 ...
	 * @param cacheDir          Directory for file caching
	 * @param reserveCacheDir   null-ok; Reserve directory for file caching. It's used when the primary directory isn't available.
	 * @param fileNameGenerator {@linkplain com.zftlive.android.library.third.universalimageloader.cache.disc.naming.FileNameGenerator
