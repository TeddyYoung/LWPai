...
public class MipcaActivityCapture extends Activity implements Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tvCenter.setText("二维码");
		tvCenter.setTextColor(getResources().getColor(R.color.white));
		/*ImageView ivRight = (ImageView) findViewById(R.id.preview_view);
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			Toast.makeText(MipcaActivityCapture.this, "扫描二维码失败,请重新扫描",
			...
			intent.setClass(MipcaActivityCapture.this,
					ZxingResultActivity.class);
			Log.i("zzurl", resultString);
