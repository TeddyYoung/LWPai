...
import com.yfzx.library.common.share.OnekeyShare;
...
public class ToolShareSDK {
	...
	public Platform initPlatform(SharePlatform type) {
		...
		switch (type) {
		case SinaWeibo:
			platForm = ShareSDK.getPlatform(MApplication.getContext(),
					SinaWeibo.NAME);
			break;
		case TencentWeibo:
			platForm = ShareSDK.getPlatform(MApplication.getContext(),
	 ...
	 * @param parms
	 *            分享参数
	 *            <a>http://wiki.mob.com/Android_%E4%B8%8D%E5%90%8C%E5%B9%B3
	 *            %E5%8F
	 *            %B0%E5%88%86%E4%BA%AB%E5%86%85%E5%AE%B9%E7%9A%84%E8%AF%A6
	 *            %E7%BB
	 *            %86%E8%AF%B4%E6%98%8E#.E6.96.B0.E6.B5.AA.E5.BE.AE.E5.8D.9A</a>
	 * @param pw
	 *            弹出分享的POP窗口
	 */
	public void share(Platform platForm, ShareParams parms, PopupWindow pw) {
		...
		try {
			...
			if (platForm.getName().equals(WechatMoments.NAME)
				...
				oks.setNotification(ToolResource.getDrawableId("ic_launcher"),
						"正在分享");
				 ...
				 * ShareContentCustomizeDemo()); // 去除注释，演示在九宫格设置自定义的图标 Bitmap
				 * logo = BitmapFactory.decodeResource(menu.getResources(),
				 * R.drawable.ic_launcher); String label =
				 * menu.getResources().getString(R.string.app_name);
				 * OnClickListener listener = new OnClickListener() { public
				 * void onClick(View v) { String text =
				 * "Customer Logo -- ShareSDK " + ShareSDK.getSDKVersionName();
				 * Toast.makeText(menu.getContext(), text,
				 * Toast.LENGTH_SHORT).show(); oks.finish(); } };
				 * oks.setCustomerLogo(logo, label, listener); //
				 * 去除注释，则快捷分享九宫格中将隐藏新浪微博和腾讯微博
				 * oks.addHiddenPlatform(SinaWeibo.NAME);
				 * oks.addHiddenPlatform(TencentWeibo.NAME); //
				 * 为EditPage设置一个背景的View oks.setEditPageBackground(getPage());
				 */
				oks.show(mContext);
			}
	...
	public class SharePlatformActionListener implements PlatformActionListener {
		...
		public void onComplete(Platform arg0, int arg1,
			...
			// 记录日志
			Log.i(TAG, "分享完成 Platform=" + arg0.toString() + "arg1=" + arg1
					+ "HashMap=" + arg2.toString());
		}
		...
		public void onError(Platform arg0, int arg1, Throwable arg2) {
			...
			// 记录日志
			Log.i(TAG, "分享失败 Platform=" + arg0.toString() + "arg1=" + arg1
					+ "异常=" + arg2.toString());
		}
