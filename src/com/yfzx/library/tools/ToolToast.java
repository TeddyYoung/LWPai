...
public class ToolToast {
	...
	public static void showLong(String msg) {
		buildToast(MApplication.getContext(), msg, Toast.LENGTH_LONG).show();
	}
	...
	public static void showLong(int msg) {
		buildToast(MApplication.getContext(),
				MApplication.getContext().getString(msg), Toast.LENGTH_LONG)
				.show();
	}
	...
	public static void showShort(String msg) {
		...
		buildToast(MApplication.getContext(), msg, Toast.LENGTH_SHORT).show();
	}
	...
	public static void showShort(int msg) {
		buildToast(MApplication.getContext(),
				MApplication.getContext().getString(msg), Toast.LENGTH_SHORT)
				.show();
	}
	 ...
	 */
	public static Toast buildToast(Context context, String msg, int duration,
			String bgColor, int textSp, int cornerRadius) {
