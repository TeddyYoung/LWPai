...
import com.yfzx.library.data.message.NotificationMessage;
import com.yfzx.library.widget.ProgressDialog;
...
public class ToolAlert {
	...
	public static void toastShort(String msg) {
		Toast.makeText(MApplication.getContext(), msg, Toast.LENGTH_SHORT)
				.show();
	}
	...
	public static void toastLong(String msg) {
		Toast.makeText(MApplication.getContext(), msg, Toast.LENGTH_LONG)
				.show();
	}
	...
	public static void toast(String msg, int duration) {
		Toast.makeText(MApplication.getContext(), msg, duration).show();
	}
	 ...
	 *            popview布局view
	 * @param direction
	 *            在目标控件的方向：上(Direction.UP)、右(Direction.RIGHT)、下(Direction.DOWN)、
	 *            左(Direction.LEFT)
	 * @return
	 */
	public static PopupWindow popwindowLoction(PopupWindow pw, View anchor,
			View popView, Direction direction) {
		...
		case LEFT:
			if (pw.isShowing()) {
				...
				pw.showAtLocation(anchor, Gravity.NO_GRAVITY,
						location[0] - pw.getWidth(), location[1]);
			}
			break;
		case RIGHT:
			if (pw.isShowing()) {
				pw.update(location[0] + anchor.getWidth(), location[1],
						LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
			} else {
				pw.showAtLocation(anchor, Gravity.NO_GRAVITY, location[0]
