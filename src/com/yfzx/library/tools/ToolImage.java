...
import com.yfzx.library.universalimageloader.UnlimitedDiskCache;
...
public abstract class ToolImage {
	 ...
	 * @return
	 */
	public static DisplayImageOptions getFadeOptions(int errorImageResid,
			int emptyImageResId) {
	 ...
	 * @return
	 */
	public static DisplayImageOptions getRoundedOptions(int errorImageResid,
			int roundPixels) {
		DisplayImageOptions options = new DisplayImageOptions.Builder()
		// 设置图片加载/解码过程中错误时候显示的图片
				.showImageOnFail(errorImageResid)
