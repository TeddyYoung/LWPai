 ...
 * @Date: 2015年7月23日
 */
public class BidRecordAdapter extends BaseListAdapter<DidResultEntity> {

	private int type;

	public BidRecordAdapter(Activity context, List<DidResultEntity> list,
			int type) {
	...
	public View bindView(int position, View convertView, ViewGroup parent) {
		...
		DidResultEntity date = list.get(position);
		// 头像
