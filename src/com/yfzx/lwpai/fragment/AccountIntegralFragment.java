...
import com.yfzx.lwpai.adapter.IntegralAdapter;
import com.yfzx.lwpai.entity.IntegralEntity;
 ...
 * @Date: 2015-7-21
 */
public class AccountIntegralFragment extends BaseFragment {
	...
	public static AccountIntegralFragment newInstance(int type) {
		Bundle bundle = new Bundle();
		bundle.putInt("type", type);
		AccountIntegralFragment fragment = new AccountIntegralFragment();
	...
	private void initWidget() {
		adapter = new IntegralAdapter(act, new ArrayList<ResultEntity>());
	...
	private void getUserBalance() {
		...
		httpClient.url.append("api/members/GetUserIntegralList");// 积分列表
		...
		httpClient.post(new xResopnse() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				IntegralEntity response = JsonUtil.parseObject(act,
						responseInfo.result, IntegralEntity.class);
				if (response != null) {
