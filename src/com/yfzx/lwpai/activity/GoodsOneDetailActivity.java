...
public class GoodsOneDetailActivity extends BaseActivity {
	// 标题
	...
	// 2个标签的下划线
	@ViewInject(R.id.ivLineLuck)
	private ImageView ivLineLuck2;
	@ViewInject(R.id.ivLineRed)
	private ImageView ivLineRed2;
	// 一元拍的下划线
	...
	private ImageView ivLineLuck2H;
	private ImageView ivLineRed2H;
	 ...
	 * @param type
	 */
	private void getLuckData(int type) {
		// 获取详细页面数据
				...
				if (response != null) {
					...
					case 2: {// 结束
						...
						btn_Bidders.setBackgroundDrawable(getResources()
								.getDrawable(R.drawable.shape_btn_gray));
						break;
					}
					}
				}
